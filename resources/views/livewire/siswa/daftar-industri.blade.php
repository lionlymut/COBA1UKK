        ...
        <div class="overflow-y-auto border border-gray-300 rounded pb-6" style="max-height: 23rem;">
            <table class="w-full table-auto border-collapse">
                <thead class="bg-gray-100 text-gray-700">
                    <tr>
                        <th class="p-3 text-left font-medium border-b border-gray-300 sticky top-0 bg-gray-100 z-10">Nama Industri</th>
                        <th class="p-3 text-left font-medium border-b border-gray-300 sticky top-0 bg-gray-100 z-10">Bidang Usaha</th>
                        <th class="p-3 text-left font-medium border-b border-gray-300 sticky top-0 bg-gray-100 z-10">Alamat</th>
                        <th class="p-3 text-left font-medium border-b border-gray-300 sticky top-0 bg-gray-100 z-10">Kontak</th>
                        <th class="p-3 text-left font-medium border-b border-gray-300 sticky top-0 bg-gray-100 z-10">Email</th>
                    </tr>
                </thead>
                <tbody>
